  ...
  useEffect(() => {
    const verifyCookie = async () => {
      try {
        ...
        const res = await fetch("/backend/auth/dashboard", {
          method: "POST",
          credentials: "include",
        });
    ...
    <div className="header">
      <div className="background">
        <div className="top">
          ...
          <div className="right">
            <button className="rightbtn">&#11206 Hi, user<img src="assets/images/user.png" /></button>
            <div className="right-content">
              ...
              <Link to="#" onClick={confirmLogout}>Log Out</Link>
            </div>
          </div>
        </div>
      </div>
